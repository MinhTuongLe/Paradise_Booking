...
export const booking_status = [
  {
    id: 1,
    name: "Pending",
    icon: <MdPending className="text-[22px] text-[#ffa700]" color="#ffa700" />,
    color: "#ffa700",
  },
  {
    id: 2,
    name: "Successful",
    icon: (
      <FaCheckCircle className="text-[20px] text-[#05a569]" color="#05a569" />
    ),
    color: "#05a569",
  },
  {
    ...
    name: "Checkin",
    icon: (
      <FaCalendarAlt className="text-[22px] text-[#55bdbf]" color="#55bdbf" />
    ),
    color: "#55bdbf",
  },
  {
    ...
    name: "Checkout",
    icon: (
      <FaCalendarCheck className="text-[22px] text-[#58a1d8]" color="#58a1d8" />
    ),
    color: "#58a1d8",
  },
  {
    ...
    icon: (
      <MdIncompleteCircle
        className="text-[22px] text-[#1975d3]"
        color="#1975d3"
      />
    ),
    color: "#1975d3",
  },
  {
    id: 6,
    name: "Cancel",
    icon: <MdCancel className="text-[22px] text-[#f44668]" color="#f44668" />,
    color: "#f44668",
  },
];
