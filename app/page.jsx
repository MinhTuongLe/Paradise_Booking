...
export default async function Home({ searchParams }) {
  ...
  return (
    <ClientOnly>
      <Container>
        <div className="pt-24 grid grid-cols-5 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-5 2xl:col-span-1 gap-8 overflow-x-hidden">
          {places &&
            places.map((place) => {
              return (
                <ListingCard
